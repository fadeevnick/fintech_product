...
submit_evidence() {
  ...
  local evidence_json='{"narrative":"Representment package for arbitration LOST runtime path.","attachments":[{"fileName":"receipt.pdf","contentType":"application/pdf","storageKey":"chargeback-evidence/runtime/receipt.pdf","sizeBytes":12345}]}'
