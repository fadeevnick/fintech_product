...
Next planned step:
- Decide whether the next Phase 04 slice covers Stripe Connect onboarding (`MRC-01`), Stripe webhook receiver (`MRC-02`) or moves toward Phase 05 card path; the API key and idempotency primitives are now available as a foundation.
