...
Last updated: 2026-05-17 (Phase 04 Slice 01 API keys/idempotency and Slice 02 webhook backend/runtime sub-scopes executed; Phase 04 Slice 03 merchant dashboard payments/webhook config planning draft created; UEW-UI-03 prototype accepted; MRC-01 blocked on Stripe sandbox credentials).
...
- Review/approve or revise `planning/implementation-slices/phase_04_slice_03_merchant_dashboard_payments_planning.md`; alternatively provide real Stripe Connect sandbox credentials to implement `MRC-01`. The merchant API key, public idempotency and inbound webhook primitives are now available as foundations.
